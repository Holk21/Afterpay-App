...
-- Merchant: create order for a target customer
RegisterNUICallback('staff:merchant:createOrder', function(data, cb)
    TriggerServerEvent('qb-afterpay:server:merchant:createOrder', data)
    cb('ok')
end)
